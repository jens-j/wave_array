...
entity table_interpolator is
    ...
    port (
        ...
        mipmap_addresses        : in  t_mipmap_address_array(0 to N_OSCILLATORS - 1)
...
architecture arch of table_interpolator is
    ...
    constant PIPE_LEN_ADDR      : integer := 1; -- Sample & coefficient memory access.
    ...
    type t_counter_array is array 0 to PIPE_LEN_TOTAL + 1 of integer range 0 to N_OSCILLATORS - 1; -- One extra register to use in the writeback stage which is not really part of the pipeline.
...
begin
    ...
    begin
        ...
        if r.pipeline_counter = PIPE_LEN_TOTAL then
            r.sample_buffers(r.osc_counter(PIPE_LEN_TOTAL + 1))
