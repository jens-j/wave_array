...
vcom -2008 -work ip $SOURCE_DIR/ip/clk_generator_sim_netlist.vhdl
vcom -2008 -work ip $SOURCE_DIR/ip/xadc_gen.vhd
vcom -2008 -work ip $SOURCE_DIR/ip/i2s_fifo.vhd
vcom -2008 -work ip $SOURCE_DIR/ip/midi_fifo_sim_netlist.vhdl
